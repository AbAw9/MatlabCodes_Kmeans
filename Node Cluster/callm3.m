...
c1=[26 29 4 3 2 27 7 13];c2=[12 1 16 8 19 17 20];c3=[25 10 9 28 11 23 24];c4=[14 6 18 21 15 5 22];

G(c1)=1;G(c2)=7;G(c3)=6;G(c4)=5;

C1(c1)=1;C1([c2 c3 c4])=2;C2([c1 c2])=1; C2([c3 c4])=2;C3([c1 c3])=1; C3([c2 c4])=2;C4([c1 c4])=1; C4([c2 c3])=2;C5([c1 c2 c3])=1; C5(c4)=2;C6([c1 c2 c4])=1; C6(c3)=2;C7([c1 c3 c4])=1; C7(c2)=2;
